...
void VoxelEngine::gen_top(const glm::vec3 &min, const glm::vec3 &max, const BlockDescription &desc)
{
    // Top / +Y
...
void VoxelEngine::gen_bottom(const glm::vec3 &min, const glm::vec3 &max,
