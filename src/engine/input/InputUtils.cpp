...
Key utils::keyFromGlfw(int glfw_key)
{
    switch (glfw_key)
    {
    case GLFW_KEY_UNKNOWN: return Key::KEY_UNKNOWN;
    ...
    case GLFW_KEY_GRAVE_ACCENT: return Key::KEY_GRAVE_ACCENT;
    case GLFW_KEY_WORLD_1: return Key::KEY_WORLD_1;
    case GLFW_KEY_WORLD_2: return Key::KEY_WORLD_2;
    ...
    case GLFW_KEY_PRINT_SCREEN: return Key::KEY_PRINT_SCREEN;
    case GLFW_KEY_PAUSE: return Key::KEY_PAUSE;
    ...
    case GLFW_KEY_KP_EQUAL: return Key::KEY_KP_EQUAL;
    case GLFW_KEY_LEFT_SHIFT: return Key::KEY_LEFT_SHIFT;
    case GLFW_KEY_LEFT_CONTROL: return Key::KEY_LEFT_CONTROL;
    ...
    case GLFW_KEY_RIGHT_CONTROL: return Key::KEY_RIGHT_CONTROL;
    case GLFW_KEY_RIGHT_ALT: return Key::KEY_RIGHT_ALT;
    case GLFW_KEY_RIGHT_SUPER: return Key::KEY_RIGHT_SUPER;
    case GLFW_KEY_MENU: return Key::KEY_MENU;
    default: return Key::KEY_UNKNOWN;
    }
}

Button utils::buttonFromGlfw(int glfw_button)
{
    switch (glfw_button)
    {
    case GLFW_MOUSE_BUTTON_1: return Button::BUTTON_1;
    case GLFW_MOUSE_BUTTON_2: return Button::BUTTON_2;
    case GLFW_MOUSE_BUTTON_3: return Button::BUTTON_3;
    case GLFW_MOUSE_BUTTON_4: return Button::BUTTON_4;
    case GLFW_MOUSE_BUTTON_5: return Button::BUTTON_5;
    case GLFW_MOUSE_BUTTON_6: return Button::BUTTON_6;
    case GLFW_MOUSE_BUTTON_7: return Button::BUTTON_7;
    case GLFW_MOUSE_BUTTON_8: return Button::BUTTON_8;
    default: assert(0); return Button::BUTTON_1;
    }
}
