...
// bool boxInFrustum( FrustumPlanes const & fru, bound3 const & box )
// {
//     // check box outside/inside of frustum
//     for( int i=0; i<6; i++ )
//     {
//         int out = 0;
//         out += ((glm::dot( fru.planes[i], glm::vec4(box.mMinX, box.mMinY, box.mMinZ, 1.0f) ) < 0.0 )?1:0);
//         out += ((glm::dot( fru.planes[i], glm::vec4(box.mMaxX, box.mMinY, box.mMinZ, 1.0f) ) < 0.0 )?1:0);
//         out += ((glm::dot( fru.planes[i], glm::vec4(box.mMinX, box.mMaxY, box.mMinZ, 1.0f) ) < 0.0 )?1:0);
//         out += ((glm::dot( fru.planes[i], glm::vec4(box.mMaxX, box.mMaxY, box.mMinZ, 1.0f) ) < 0.0 )?1:0);
//         out += ((glm::dot( fru.planes[i], glm::vec4(box.mMinX, box.mMinY, box.mMaxZ, 1.0f) ) < 0.0 )?1:0);
//         out += ((glm::dot( fru.planes[i], glm::vec4(box.mMaxX, box.mMinY, box.mMaxZ, 1.0f) ) < 0.0 )?1:0);
//         out += ((glm::dot( fru.planes[i], glm::vec4(box.mMinX, box.mMaxY, box.mMaxZ, 1.0f) ) < 0.0 )?1:0);
//         out += ((glm::dot( fru.planes[i], glm::vec4(box.mMaxX, box.mMaxY, box.mMaxZ, 1.0f) ) < 0.0 )?1:0);
